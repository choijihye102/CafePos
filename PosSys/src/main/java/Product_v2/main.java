...
import Admin_management.Admin_managementView3;
import CommunityPage.Community_View;
...
public class main {
    ...
    private void initialize() {
        ...
        btnAdmin.addActionListener((ActionEvent e) -> {
            ...
            Admin_managementView3 admin = new Admin_managementView3();
            frame.dispose();
        });
     ...
     // 커뮤니티 버튼 클릭 이벤트
        btncommunity.addActionListener((ActionEvent e) -> {
         ...
         //   login_view2.main(new String[]{});  // login_view2의 main 메서드를 호출하여 로그인 화면으로 이동
            Community_View cmnt =  new Community_View();
            cmnt.show();
