...
public class P2 implements ActionListener {
	...
	private int currentMileage  = 0; //사용한 마일리지.
	...
	private void updateTotalNum() {
		...
		newModel2.addRow(new Object[] { totalPrice, cus_point > 0 ? cus_point : currentMileage });
	...
	private void handleCardPayment() {
		...
		try {
			...
			order.setUsed_point(cus_point); 	// 추가사항 사용한 마일리지.
